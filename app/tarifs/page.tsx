    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <header className="border-b border-slate-200 bg-white/80 backdrop-blur-sm sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          >
            {authenticated ? 'Mon tableau de bord' : 'Espace Étudiant / Connexion'}
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6 tracking-tight">
            ...
            <span className="block text-blue-900 mt-2">certifiez-vous avec Premium</span>
          </h2>
          <p className="text-lg text-slate-600 leading-relaxed">
            Le diagnostic et les niveaux 1-2 sont offerts. Passez Premium quand vous êtes prêt
            pour le programme complet et la certification.
          </p>
        </div>
        ...
        <section className="mt-20 max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {FAQ_ITEMS.map((item) => (
              <div key={item.q} className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
